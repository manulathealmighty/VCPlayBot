...
💡 **Find out all the Bot’s commands and how they work by clicking on the » 📚 𝗖𝗼𝗺𝗺𝗮𝗻𝗱𝘀 button !**

❓ **For information about all features of this bot, just type /help**
    ...
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "✨ Group", url=f"https://t.me/luvchaeyoung_botupdates"
                    ),
                    InlineKeyboardButton(
                        "📣 Channel", url=f"https://t.me/RoseannePark_updates"
                    )
                ]
            ]
        )
