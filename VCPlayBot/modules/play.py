            ...
            if administrator == message.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        ...
                        "\n\nOr manually add assistant to your Group and try again manually request here @luvchaeyoung_botupdates with your group link</b>",
                    )
    try:
        ...
        await lel.edit(
            f"<i> {user.first_name} Userbot not in this chat, Ask admin to send /play command for first time or add {user.first_name} manually request here @luvchaeyoung_bot with your group link</i>"
        )
        return
    text_links=None
